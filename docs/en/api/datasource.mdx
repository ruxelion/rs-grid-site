...
description: DataSource trait, CellStatus enum, and the storage module reference.
---
...
See [Data Sources Overview](/data/overview) for the full explanation and
[VecDataSource](/data/vec-datasource), [FnDataSource](/data/fn-datasource),
[PageCache](/data/page-cache) for built-in implementations.
