...
| `export_patches()` | Exporte les cellules editees en TSV versionne — voir [Persister les modifications](/fr/data/extracting-data#persister-les-modifications) |
| `import_patches(tsv)` | Importe des patches TSV dans la grille — voir [Persister les modifications](/fr/data/extracting-data#persister-les-modifications) |
