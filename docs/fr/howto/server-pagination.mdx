---
title: "Guide : Pagination côté serveur"
description: Charger de grands jeux de données depuis un serveur avec PageCacheDataSource et FetchConfig.
---
...
- La grille appelle `GridCommand::SetTotalRowCount` (garde la gouttière des
  ...
  serveur](/fr/data/page-cache)) puis `GridCommand::NotifyPageLoaded` en
...
- [Source de données PageCache](/fr/data/page-cache)
- [API DataSource](/fr/api/datasource)
- [Callbacks et persistance](/fr/features/callbacks)
