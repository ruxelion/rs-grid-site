...
| `filter_row_height` | `f64` | `36.0` | Hauteur de la ligne de filtre flottante (px logiques) — voir [Filtrage](/fr/features/filtering) |
...
| `filters` | `HashMap<String, FilterCondition>` | vide | Conditions de filtre par colonne — voir [Filtrage](/fr/features/filtering) |
| `value_filters` | `HashMap<String, HashSet<String>>` | vide | Restrictions par ensemble de valeurs par colonne (filtre à cases à cocher), combinées en ET avec `filters` — voir [Filtrage](/fr/features/filtering) |
