...
| `set_on_validation_state_changed` | État de validation live modifié à chaque `StartEdit` / `ValidateEdit` / `CommitEdit` / `CancelEdit` — voir [Validation](/fr/features/validation) |
