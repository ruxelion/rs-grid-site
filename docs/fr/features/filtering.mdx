---
title: Filtrage
description: Filtrage par condition, colonne par colonne (contient, égal, supérieur à, ...), plus une liste à cases à cocher façon AG Grid, via une ligne de filtre flottante optionnelle et un popup, ou l'API programmatique.
---
...
- « (Tout sélectionner) » est un vrai contrôle tri-état (coché / décoché
  / indéterminé), agissant sur les valeurs actuellement *visibles*
