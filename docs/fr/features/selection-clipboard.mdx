...
description: Opérations copier, couper et coller au format TSV.
---
...
Pour plus de détails sur le modèle de sélection de base, voir [Sélection](/concepts/selection).
...
[Validation](/fr/features/validation) pour comment une cellule requise
...
[Menu contextuel](/features/context-menu) pour les options de personnalisation.
