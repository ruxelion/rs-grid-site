...
20 cols × 10k rows35.9 µs

50 cols × 1M rows45.4 µs

100 cols × 10M rows55.2 µs

1 000 cols × 1B rows57.1 µs
...
| 1 billion rows, 1 000 cols | 74.3 ns |
| 1 quadrillion rows, 1 000 cols | 47.4 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `8d8d785` · July 1, 2026. Updated automatically on every push to `main` via CI.
