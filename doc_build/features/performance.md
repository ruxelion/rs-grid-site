...
20 cols × 10k rows27.8 µs

50 cols × 1M rows41.3 µs

100 cols × 10M rows50.7 µs

1 000 cols × 1B rows51.9 µs

50 cols × 1 quadrillion42.9 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 31.2 ns |
| 1 billion rows, 1 000 cols | 39.8 ns |
| 1 quadrillion rows, 1 000 cols | 29.0 ns |
...
| 1 000 000 | 2.6 µs |
| 100 000 000 | 2.6 µs |
| 1 000 000 000 | 2.6 µs |
| 1 000 000 000 000 000 | 2.6 µs |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `37f8adc` · July 9, 2026. Updated automatically on every push to `main` via CI.
