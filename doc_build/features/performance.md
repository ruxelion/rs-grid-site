...
20 cols × 10k rows41.3 µs

50 cols × 1M rows50.2 µs

100 cols × 10M rows62.4 µs

1 000 cols × 1B rows63.6 µs

50 cols × 1 quadrillion53.1 µs
...
| 1 billion rows, 1 000 cols | 74.8 ns |
| 1 quadrillion rows, 1 000 cols | 64.0 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `c6c86b8` · July 9, 2026. Updated automatically on every push to `main` via CI.
