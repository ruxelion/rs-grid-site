...
20 cols × 10k rows37.6 µs

50 cols × 1M rows45.9 µs

100 cols × 10M rows57.2 µs

1 000 cols × 1B rows64.6 µs

50 cols × 1 quadrillion48.5 µs
...
| 1 billion rows, 1 000 cols | 77.7 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `9821734` · July 2, 2026. Updated automatically on every push to `main` via CI.
