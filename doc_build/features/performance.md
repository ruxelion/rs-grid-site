...
50 cols × 1M rows52.4 µs

100 cols × 10M rows65.4 µs

1 000 cols × 1B rows66.3 µs

50 cols × 1 quadrillion57.6 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 64.3 ns |
| 1 billion rows, 1 000 cols | 74.9 ns |
| 1 quadrillion rows, 1 000 cols | 64.5 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `200530b` · July 9, 2026. Updated automatically on every push to `main` via CI.
