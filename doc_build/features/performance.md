...
20 cols × 10k rows41.7 µs

50 cols × 1M rows52.2 µs

100 cols × 10M rows63.3 µs

1 000 cols × 1B rows65.1 µs

50 cols × 1 quadrillion54.4 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 64.8 ns |
| 1 billion rows, 1 000 cols | 75.2 ns |
| 1 quadrillion rows, 1 000 cols | 62.5 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `d27ca9a` · July 8, 2026. Updated automatically on every push to `main` via CI.
