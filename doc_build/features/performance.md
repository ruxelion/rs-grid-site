...
20 cols × 10k rows28.0 µs

50 cols × 1M rows36.1 µs

100 cols × 10M rows44.8 µs

1 000 cols × 1B rows45.1 µs

50 cols × 1 quadrillion36.9 µs
...
| 1 billion rows, 1 000 cols | 56.3 ns |
| 1 quadrillion rows, 1 000 cols | 37.1 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `38aba15` · July 2, 2026. Updated automatically on every push to `main` via CI.
