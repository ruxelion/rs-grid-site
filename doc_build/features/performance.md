...
20 cols × 10k rows35.5 µs

50 cols × 1M rows44.5 µs

100 cols × 10M rows55.0 µs

1 000 cols × 1B rows56.5 µs

50 cols × 1 quadrillion45.9 µs
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `25462b0` · July 1, 2026. Updated automatically on every push to `main` via CI.
