...
20 cols × 10k rows36.8 µs

50 cols × 1M rows46.3 µs

100 cols × 10M rows56.9 µs

1 000 cols × 1B rows58.1 µs

50 cols × 1 quadrillion48.4 µs
...
| 1 quadrillion rows, 1 000 cols | 64.9 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `927cc5c` · July 2, 2026. Updated automatically on every push to `main` via CI.
