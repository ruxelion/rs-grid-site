...
50 cols × 1M rows46.0 µs

100 cols × 10M rows56.8 µs

1 000 cols × 1B rows58.3 µs

50 cols × 1 quadrillion49.1 µs
...
| 1 billion rows, 1 000 cols | 77.8 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `5c135ca` · July 2, 2026. Updated automatically on every push to `main` via CI.
