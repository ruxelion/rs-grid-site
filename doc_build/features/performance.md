...
100 cols × 10M rows62.6 µs

1 000 cols × 1B rows63.9 µs

50 cols × 1 quadrillion52.1 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 48.1 ns |
| 1 billion rows, 1 000 cols | 74.1 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `919c8a2` · July 8, 2026. Updated automatically on every push to `main` via CI.
