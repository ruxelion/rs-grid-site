...
| `export_patches()`               | Export edited cell values as versioned TSV — see [Persisting edits](/data/extracting-data.md#persisting-edits) |
| `import_patches(tsv)`            | Import TSV patches into the grid — see [Persisting edits](/data/extracting-data.md#persisting-edits)           |
