...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `e64373e` · July 2, 2026. Updated automatically on every push to `main` via CI.
