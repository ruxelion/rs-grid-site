...
20 cols × 10k rows30.9 µs

50 cols × 1M rows43.3 µs

100 cols × 10M rows52.7 µs

1 000 cols × 1B rows54.0 µs

50 cols × 1 quadrillion45.3 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 37.0 ns |
| 1 billion rows, 1 000 cols | 52.6 ns |
| 1 quadrillion rows, 1 000 cols | 36.0 ns |
...
| 1 000 000 | 3.8 µs |
| 100 000 000 | 3.8 µs |
| 1 000 000 000 | 3.8 µs |
| 1 000 000 000 000 000 | 3.8 µs |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `9aa713a` · July 1, 2026. Updated automatically on every push to `main` via CI.
