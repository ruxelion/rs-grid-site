...
20 cols × 10k rows40.0 µs

50 cols × 1M rows51.2 µs

100 cols × 10M rows62.4 µs

1 000 cols × 1B rows63.2 µs

50 cols × 1 quadrillion53.2 µs
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `90552a0` · July 7, 2026. Updated automatically on every push to `main` via CI.
