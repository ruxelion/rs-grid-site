...
50 cols × 1M rows46.7 µs

100 cols × 10M rows57.1 µs
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `a1a8d54` · July 2, 2026. Updated automatically on every push to `main` via CI.
