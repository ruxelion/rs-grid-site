...
| --- | --- |
| 1 000 rows, 1 000 cols | — |
| 1 billion rows, 1 000 cols | — |
| 1 quadrillion rows, 1 000 cols | — |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `c6a8a3a` · June 20, 2026. Updated automatically on every push to `main` via CI.
