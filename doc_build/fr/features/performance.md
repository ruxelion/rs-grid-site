...
50 cols × 1M rows35.0 µs

100 cols × 10M rows43.4 µs

1 000 cols × 1B rows44.5 µs

50 cols × 1 quadrillion36.0 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 38.7 ns |
| 1 billion rows, 1 000 cols | 56.4 ns |
| 1 quadrillion rows, 1 000 cols | 36.9 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `912f9e0` · July 2, 2026. Updated automatically on every push to `main` via CI.
