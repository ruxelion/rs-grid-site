...
50 cols × 1M rows51.6 µs

100 cols × 10M rows63.6 µs

1 000 cols × 1B rows63.9 µs

50 cols × 1 quadrillion54.3 µs
...
| 1 billion rows, 1 000 cols | 75.0 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `7ef8de6` · July 8, 2026. Updated automatically on every push to `main` via CI.
