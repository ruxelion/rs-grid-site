...
20 cols × 10k rows36.3 µs

50 cols × 1M rows49.5 µs

100 cols × 10M rows59.8 µs

1 000 cols × 1B rows61.2 µs

50 cols × 1 quadrillion52.0 µs
...
| --- | --- |
| 1 000 rows, 1 000 cols | 36.8 ns |
| 1 billion rows, 1 000 cols | 52.4 ns |
| 1 quadrillion rows, 1 000 cols | 35.3 ns |
...
Measured with Criterion (sample-size=10) on `ubuntu-22.04` · commit `5108583` · July 7, 2026. Updated automatically on every push to `main` via CI.
