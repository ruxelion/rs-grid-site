...
| `--rs-grid-checked-row-bg`         | `checked_row_bg`         | `rgba(66,42,213,0.09)`   | `rgba(99,80,240,0.12)`   | Background overlay for a row checked via the [row-selection checkbox column](/concepts/selection.md#row-selection-checkbox-column)        |
...
| `--rs-grid-invalid-cell-border-width` | `invalid_cell_border_width` | `1px`   | px   | Width of the at-rest invalid-cell border            |
