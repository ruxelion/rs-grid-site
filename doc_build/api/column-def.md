...
| `validator` | `Option<CellValidator>` | Legacy validator, kept for backward compatibility. Prefer `rules` for new code — see [Validation](/features/validation.md) |
...
See [Per-cell editability](/features/editing.md#per-cell-editability) for the
...
directly by your closure — not read from the [theme](/theming/css-variables.md).
